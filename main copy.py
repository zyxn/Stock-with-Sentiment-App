...
from Models.ModelXGBoost import ModelXGBoost  # Pastikan ini diimport
...
if __name__ == "__main__":
    ...
    if model_type == "XGBoost":
        ...
        model._set_params(model.params)  # Mengatur hyperparameter terbaik yang ditemukan ke model
